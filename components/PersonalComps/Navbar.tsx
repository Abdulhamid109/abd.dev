        ...
        <div className='fixed z-50 top-2 w-screen left-0 right-0 bottom-0 text-center'>
            <div className='p-2 w-full flex justify-center'>
                <div className='bg-[#05071D]/10 p-2 gap-2 md:gap-4 list-none flex rounded-md backdrop-blur-2xl shadow-xl shadow-black'>
                    <li className='p-2 hover:underline hover:scale-110 hover:transition-all hover:duration-200'>About</li>
                    <li className='p-2 hover:underline hover:scale-110 hover:transition-all hover:duration-200'>Projects</li>
