        ...
        <div className='h-screen w-screen flex flex-col justify-center items-center bg-[#05071D]/[0.96]'>
            ...
            <div className='flex justify-center items-center flex-wrap md:gap-3'>
                ...
                <div className='flex flex-col'>
                    <div className='bg-[url(/earth.png)] shadow-black bg-cover w-[23rem] h-[20rem] backdrop-blur-2xl shadow-2xl bg-blend-color-burn border-2 mt-3 bg-gradient-to-l from-black to-zinc-700 rounded-md'>
                        <p className='p-2 font-bold text-2xl '>I &apos;m very fexibile with time zone communications</p>
                    </div>
                    <div className="backdrop-blur-2xl w-[23rem] h-[10rem] mt-3 shadow-2xl bg-black/10 rounded-md border-2 p-4 shadow-black">
                ...
                <div>
                    <div className="relative bg-[url(/demo-img.png)] shadow-black bg-cover md:w-[60rem] w-[23rem] h-[10rem] backdrop-blur-2xl shadow-2xl bg-blend-color-burn border-2 mt-3 bg-gradient-to-l from-black to-zinc-700 rounded-md">
